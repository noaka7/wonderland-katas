...
#if CGW_ENABLE_MAX_ROUND
#define ROUNDN_SMALLER_THAN_MAX_ROUND (roundn <= CGW_MAX_ROUND)
#else
#define ROUNDN_SMALLER_THAN_MAX_ROUND 1
#endif // CGW_ENABLE_MAX_ROUND
...
static void init_game(HAND *, HAND *);
...
static void init_game(HAND *p1, HAND *p2) {
